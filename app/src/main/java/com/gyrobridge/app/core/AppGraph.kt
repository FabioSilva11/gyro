...
class RuntimeState {
    ...
    fun reset() { setSession(false); setCalibrating(false); setProfile(null); setMotion(MotionOutput()); setOverlayStatus(false, "Sessão encerrada"); setAutoDetectActive(false); setA11yAvailable(true) }
}
